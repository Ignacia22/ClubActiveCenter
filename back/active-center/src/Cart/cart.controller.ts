...
export class CartController {
  ...
  @ApiOperation({
    ...
    description:
      'Obtiene el carrito activo del usuario y agrega los productos indicados, validando stock y cantidad.',
  })
  @ApiResponse({
    status: 200,
    description: 'Carrito actualizado con los productos añadidos.',
  })
  @Post('add')
  ...
  @ApiOperation({
    ...
    description:
      'Busca el producto en el carrito y actualiza su cantidad. Si no existe, lanza un error.',
  })
  @ApiResponse({
    status: 200,
    description: 'Carrito actualizado con la nueva cantidad del producto.',
  })
  @Put('update')
