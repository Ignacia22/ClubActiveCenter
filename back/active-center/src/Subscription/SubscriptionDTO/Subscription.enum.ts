...
class UserSub {
  ...
  @ApiProperty({
    description: 'Indica si el usuario está suscrito',
    example: true,
  })
...
export class SubscriptionResponseDTO {
  ...
  @ApiProperty({
    ...
    example: 'Membresía Premium',
  })
  name: string;

  @ApiProperty({
    description: 'Descripción de la suscripción',
    example: 'Acceso ilimitado al gimnasio y la piscina.',
  })
  description: string;
  ...
  @ApiProperty({
    ...
    example: ['Acceso VIP', 'Entrenador personal', 'Piscina'],
  })
  benefits: string[];
