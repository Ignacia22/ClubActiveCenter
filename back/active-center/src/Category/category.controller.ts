import { 
  Controller, Get, Post, Delete, Put, Body, Param, Query, UseGuards, SetMetadata 
} from '@nestjs/common';
...
export class CategoryController {
  ...
  @ApiOperation({ 
    ...
    description: 'Devuelve una lista con todas las categorías disponibles en la base de datos.'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Permite realizar una búsqueda parcial de categorías según su nombre.'
  })
  @ApiQuery({ name: 'name', required: true, description: 'Nombre de la categoría a buscar' })
  ...
  @ApiOperation({ 
    ...
    description: 'Devuelve los detalles de una categoría específica según su ID.'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Crea una nueva categoría en la base de datos con el nombre proporcionado.'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Modifica el nombre de una categoría específica en la base de datos.'
  })
  async editCategory(
