...
export class ProductController {
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint permite obtener productos con paginación y filtros opcionales.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: Number,
    description: 'Filtrar productos por stock disponible',
  })
  @ApiQuery({
    name: 'minPrice',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint obtiene un producto específico a partir de su ID.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Este endpoint permite a los administradores actualizar un producto existente.',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Eliminar (retirar) un producto. (ADMIN)',
    description:
      'Este endpoint permite a los administradores retirar un producto del catálogo, en caso que ya lo este devolverlo a la tienda, y si no tiene stock al momento de devolverlo a la tienda el estado sera sin stock.',
  })
