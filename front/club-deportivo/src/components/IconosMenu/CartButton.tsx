...
export function CartButton() {
  ...
  const { items, itemCount, getCartTotal, removeItemFromCart } = useCart();
          ...
          <div className="flex flex-col h-full">
            ...
            {items.length > 0 && (
              <div className="p-4 border-t border-white/10">
                ...
                <Link href="/checkout">
                  <button className="block w-full text-center bg-white text-black py-2 px-4 rounded-md hover:bg-white/90 transition-colors">
                    Proceder al pago
                  </button>
                </Link>
              </div>
